...
@Getter
public class SagaApplicationException extends RuntimeException {

    private final int statusCode;
    private final String downstreamMessage;

    public SagaApplicationException(String message, int statusCode, String downstreamMessage) {
        super(message);
        this.statusCode = statusCode;
        this.downstreamMessage = downstreamMessage;
    }

    public SagaApplicationException(String message, int statusCode) {
